<aside>
    ...
    <?php  
			...
			//jeśli $podstrona jest pusta (strona główna - wydarzenia) lub należy do kategorie-wydarzen (również lista wydarzeń) lub kategorie-edukacji (lista kursów) to jest wczytywany obszar na widżety pasek-boczny-glowny
	
			$tablica = array('kategorie_wydarzen', 'kategorie-edukacji');
